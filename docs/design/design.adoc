...
| 0x00000000 | 0x0FFFFFFF | 0x00000000 | 0x0FFFFFFF | The first physical 128MB RAM is identity page mapping
| 0x80000000 | 0x87FFFFFF | 0x08000000 | 0x1FFFFFFF | The second physical 256MB RAM is mapped to kernel space 
|=========